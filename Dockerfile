...
# The PHI scanner's committee-maintained extensions are read at RUNTIME, so
# they ship as a file rather than being bundled — which is what lets the
# committee add a pattern without a rebuild.
